/******************************************************************************
 * lcd_font.c — 5×7 monospace ASCII font table.
 * Generated directly from the original 47-case LCD_GlyphRow switch, extended
 * to include lowercase letters (a-z) and the remaining punctuation (32..126).
 * Original only had: 0-9 A-Z - . / : = > < + * @ space.
 * Added: a-z ! " # $ % & ' ( ) , ; ? [ \ ] ^ _ ` { | } ~
 * Lowercase is a scaled uppercase design at 5×7 (no descenders).
 ******************************************************************************/

#include "lcd_font.h"

const uint8_t lcd_font_5x7[LCD_FONT_COUNT][LCD_FONT_GLYPH_H] = {
    /* 32 space */
    ...
    /* 37 % */
    {0x12,0x14,0x08,0x04,0x12,0x12,0x0C},
    /* 38 & */
